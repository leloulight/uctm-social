...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/home/zdravko/projects/laravel/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('ProcessImage', 'App\\Services\\ProcessImage');
        $this->app->bind('App\\Repositories\\Feed\\FeedRepository', 'App\\Repositories\\Feed\\EloquentFeedRepository');
        $this->app->bind('App\\Repositories\\User\\UserRepository', 'App\\Repositories\\User\\EloquentUserRepository');
        $this->app->bind('App\\Repositories\\FriendRequest\\FriendRequestRepository', 'App\\Repositories\\FriendRequest\\EloquentFriendRequestRepository');
        $this->app->bind('App\\Repositories\\Message\\MessageRepository', 'App\\Repositories\\Message\\EloquentMessageRepository');
        $this->app->bind('MessageRequest', 'App\\Http\\Requests\\CreateMessageRequest');
        $this->app->bind('MessageResponseRequest', 'App\\Http\\Requests\\CreateMessageResponseRequest');
    }
}
}
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array(UserWasRegistered::class => array(EmailRegistrationConfirmation::class), FriendRequestWasSent::class => array(EmailFriendRequest::class));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
