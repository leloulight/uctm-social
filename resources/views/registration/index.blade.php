      ...
      <div class="modal-footer">
		...
		<div class="col-md-6">
			<div id="main-title" class="row text-center">
				<h1>UCTMsocial</h1>
				<h2>A Social network app built with Laravel</h2>

				<a href="https://github.com/zdravko61/uctm-social"><i class="fa fa-github fa-2x"></i></a> <a href="#" data-toggle="modal" data-target="#welcomeModal"><i class="fa fa-info-circle fa-2x"></i></a>
				<img src="/images/new_logo.png" class="img-responsive" alt="UCTMsocial image" style="padding-left: 185px; padding-top: 10px;">
			</div>
		</div>
	</div>
